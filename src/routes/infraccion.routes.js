...
router.get('/tipos', authJWT, requireRole(ROLES.SUPERVISOR, ROLES.ADMINISTRADOR), controller.obtenerTipos);
...
router.get('/:id', authJWT, requireRole(ROLES.SUPERVISOR, ROLES.ADMINISTRADOR), controller.obtenerPorId);
