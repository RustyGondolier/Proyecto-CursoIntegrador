...
router.put(
  ...
  authJWT,
  requireRole(ROLES.ADMINISTRADOR),
  controller.aprobarPerfil,
);
router.put(
  '/usuarios/:id/suspender',
  authJWT,
  requireRole(ROLES.ADMINISTRADOR),
  controller.suspenderCuenta,
);
router.put(
  '/usuarios/:id/reactivar',
  authJWT,
  requireRole(ROLES.ADMINISTRADOR),
  controller.reactivarCuenta,
);
router.get(
  '/infracciones',
  authJWT,
  requireRole(ROLES.ADMINISTRADOR),
  controller.listarInfracciones,
);
router.get(
  '/infracciones/:id',
  authJWT,
  requireRole(ROLES.ADMINISTRADOR),
  controller.obtenerInfraccion,
);
router.get(
  '/reportes/prioritarios',
  authJWT,
  requireRole(ROLES.ADMINISTRADOR),
  controller.listarReportesPrioritarios,
);
router.put(
  '/reportes/:id/resolver',
  authJWT,
  requireRole(ROLES.ADMINISTRADOR),
  controller.resolverReporte,
);
